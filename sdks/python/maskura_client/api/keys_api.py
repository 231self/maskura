...
class KeysApi:
    ...
    def _create_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dashboard/api/keys',
    ...
    def delete_key(
        ...
        :param delete_key_request: (required)
        :type delete_key_request: DeleteKeyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _delete_key_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_key_request is not None:
            _body_params = delete_key_request
    ...
    def get_keys_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListKeyResponse]]:
        """List API keys for the authenticated user
